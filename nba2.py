...
def fetch_odds_data(date, predict):
    base_url = f"https://www.oddsshark.com/api/scores/nba/{date}?_format=json"
...
def main():
    ...
    elo_url = 'https://raw.githubusercontent.com/Neil-Paine-1/NBA-elo/main/nba_elo.csv'
    ...
    covers_urls = [
        (f'https://contests.covers.com/consensus/topconsensus/nba/overall/{today}', 'Overall Bettors'),
        (f'https://contests.covers.com/consensus/topconsensus/nba/expert/{today}', 'Team Leaders'),
        (f'https://contests.covers.com/consensus/topconsensus/nba/top10pct/{today}', 'Top 10%')
    ]
