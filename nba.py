...
URL = [
    "http://www.basketball-reference.com/leagues/NBA_2024_games-october.html",
    "http://www.basketball-reference.com/leagues/NBA_2024_games-november.html",
    "http://www.basketball-reference.com/leagues/NBA_2024_games-december.html",
...
if __name__ == "__main__":
    ...
    for K in x:
        ...
        # Add rate limiting sleep interval between requests
